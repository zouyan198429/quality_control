        ...
        <div class="slideTxtBox">
            ...
            <div class="bd">
                <ul class="searchbox">
                    ...
                    <input type="radio" name="company_field" value="company_name" id="killOrder1"  @if (isset($field) && ($field == 'company_name' || $field != 'company_credit_code') ) checked @endif><label for="killOrder1">检验机构名称</label>

      ...
      <div class="layui-col-md12">
        ...
        <div class="layui-card">
          ...
          <div class="layui-card-header">
              <h3 style="width:120px; float: left;">我的报名</h3>
          </div>
...
<img src="" alt="">
  ...
  <script type="text/javascript">
      ...
      var AJAX_URL = "{{ url('api/company/courses/order/ajax_list') }}";//ajax请求的url
      ...
      var SHOW_URL = "{{ url('company/courses/order/sign-up/show') }}/";//显示页面地址前缀 + id
  ...
  <script src="{{ asset('js/company/QualityControl/CourseOrder.js') }}"  type="text/javascript"></script>
</body>
</html>

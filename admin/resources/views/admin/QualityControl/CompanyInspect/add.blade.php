    ...
    <form class="am-form am-form-horizontal" method="post"  id="addForm">
        ...
        <table class="table1">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="inp wnormal"  name="exist_problem" value="{{ $info['exist_problem'] ?? '' }}" placeholder="请输入存在问题"/>
                </td>
            </tr>
            <tr>
...
<script src="{{ asset('/js/admin/QualityControl/CompanyInspect_edit.js') }}?6"  type="text/javascript"></script>
</body>
</html>

...
<div class="mm">
    <form class="am-form am-form-horizontal" method="post"  id="addForm">
        ...
        <table class="table1">
            <tr>
                <th>报名企业名称<span class="must">*</span></th>
                <td>
                    <input type="text" class="inp wnormal"  name="course_order_name" value="{{ $info['course_order_name'] ?? '' }}" placeholder="请输入报名企业名称"/>
                </td>
            </tr>
            <tr>
...
<script src="{{ asset('/js/admin/QualityControl/CourseOrder_edit.js') }}"  type="text/javascript"></script>
</body>
</html>

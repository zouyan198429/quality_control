...
<div class="mm">
    ...
    <div class="table-header">
        <button class="btn btn-danger  btn-xs batch_del"  onclick="assignClass()">分配班级</button>
        <button class="btn btn-success  btn-xs export_excel"  onclick="action.exportExcel(this)" >导出[勾选]</button>
        <button class="btn btn-success  btn-xs export_excel"  onclick="otheraction.frozenSelected(this, 2)" >群发短信</button>
    </div>
  ...
  <script type="text/javascript">
      ...
      var AJAX_URL = "{{ url('api/admin/courses/sign_up/staff/ajax_list') }}";//ajax请求的url
      var ASSIGN_CLASS_URL = "{{ url('admin/courses/assign_class') }}"; //分配班级url
  ...
  <script src="{{ asset('js/admin/QualityControl/CourseSignUpStaff.js') }}?1"  type="text/javascript"></script>
</body>
</html>

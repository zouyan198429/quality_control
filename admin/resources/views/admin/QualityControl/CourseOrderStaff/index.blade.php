...
<script type="text/javascript">
    ...
    var AJAX_URL = "{{ url('api/admin/courses_order_staff/management/' . $info['id']  . '/ajax_list') }}";//ajax请求的url
...
<script src="{{ asset('js/admin/QualityControl/CourseOrderStaff.js') }}"  type="text/javascript"></script>
</body>
</html>

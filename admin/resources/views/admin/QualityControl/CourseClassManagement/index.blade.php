    ...
    <div class="layui-layout layui-layout-admin">
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    <li data-name="user" class="layui-nav-item">
                        <a  lay-href="{{ url('admin/courses_class/management/' . $info['id']  . '/basic') }}" lay-tips="本班概况" lay-direction="2">
                            <i class="layui-icon layui-icon-component"></i>
                            <cite>本班概况</cite>
                        </a>
                    </li>
                    <li data-name="user" class="layui-nav-item">
                        <a  lay-href="{{ url('admin/courses_class/management/' . $info['id']  . '/course_order') }}" lay-tips="报名单位" lay-direction="2">
                            <i class="layui-icon layui-icon-component"></i>
                            <cite>报名单位</cite>
                        </a>
                    </li>
                    <li data-name="user" class="layui-nav-item">
                        <a  lay-href="{{ url('admin/courses_class/management/' . $info['id']  . '/course_order_staff') }}" lay-tips="报名学员" lay-direction="2">
                            <i class="layui-icon layui-icon-component"></i>
                            <cite>报名学员</cite>
                        </a>
                    </li>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                ...
                <iframe src="{{ url('admin/courses_class/management/' . $info['id']  . '/basic') }}" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>

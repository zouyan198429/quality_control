...
class ProjectStandardsController extends BasicController
{
    /**
     * 首页
     *
...
//    }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/project_standards/ajax_info",
     *     tags={"大后台-能力验证-项目标准"},
     *     summary="项目标准--详情",
     ...
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_project_standards_id_required"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_info_project_standards"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_QualityControl_info_project_standards"}
     */
    /**
     * ajax获得详情数据
     *
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/project_standards/ajax_save",
     *     tags={"大后台-能力验证-项目标准"},
     *     summary="项目标准--新加/修改",
...
//        }
    ...
    /**
     * @OA\Get(
     *     path="/api/admin/project_standards/ajax_alist",
     *     tags={"大后台-能力验证-项目标准"},
     *     summary="项目标准--列表",
     *     description="项目标准--列表......",
     ...
     *     deprecated=false,
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
     *     @OA\Parameter(ref="#/components/parameters/Schema_QualityControl_project_standards_id_optional"),
     *     @OA\Response(response=200,ref="#/components/responses/Response_QualityControl_list_project_standards"),
     *     @OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//    }
    ...
    /**
     * @OA\Post(
     *     path="/api/admin/project_standards/ajax_del",
     *     tags={"大后台-能力验证-项目标准"},
     *     summary="项目标准--删除",

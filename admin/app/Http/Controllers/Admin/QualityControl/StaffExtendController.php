...
class StaffExtendController extends BasicController
{
    ...
    public function index(Request $request)
    {
        ...
        return Tool::doViewPages($this, $request, function (&$reDataArr) use($request){
            ...
            return view('admin.QualityControl.StaffExtend.index', $reDataArr);
...
//            // $reDataArr = $this->reDataArr;
//            $reDataArr = array_merge($reDataArr, $this->reDataArr);
//            $reDataArr['province_kv'] = CTAPIStaffExtendBusiness::getCityByPid($request, $this,  0);
//            $reDataArr['province_kv'] = CTAPIStaffExtendBusiness::getChildListKeyVal($request, $this, 0, 1 + 0, 0);
//            $reDataArr['province_id'] = 0;
//            return view('admin.QualityControl.StaffExtend.select', $reDataArr);
//
//        }, $this->errMethod, $reDataArr, $this->errorView);
//    }
    ...
    public function add(Request $request,$id = 0)
    {
        ...
        return Tool::doViewPages($this, $request, function (&$reDataArr) use($request, &$id){
            ...
            if ($id > 0) { // 获得详情数据
                $operate = "修改";
                $info = CTAPIStaffExtendBusiness::getInfoData($request, $this, $id, [], '', []);
            }
            // $reDataArr = array_merge($reDataArr, $resultDatas);
            $reDataArr['info'] = $info;
            $reDataArr['operate'] = $operate;
            return view('admin.QualityControl.StaffExtend.add', $reDataArr);
...
//        }
        ...
        $resultDatas = CTAPIStaffExtendBusiness::replaceById($request, $this, $saveData, $id, $extParams, true);
        return ajaxDataArr(1, $resultDatas, '');
    }
    ...
    public function ajax_alist(Request $request){
        $this->InitParams($request);
        return  CTAPIStaffExtendBusiness::getList($request, $this, 2 + 4);
    }
...
//        $this->InitParams($request);
//        $result = CTAPIStaffExtendBusiness::getList($request, $this, 1 + 0);
...
//        $this->InitParams($request);
//        CTAPIStaffExtendBusiness::getList($request, $this, 1 + 0);
//    }
...
//        $this->InitParams($request);
//        CTAPIStaffExtendBusiness::importTemplate($request, $this);
//    }
    ...
    {
        $this->InitParams($request);
        return CTAPIStaffExtendBusiness::delAjax($request, $this);
    }
...
//        // 获得一级城市信息一维数组[$k=>$v]
//        $childKV = CTAPIStaffExtendBusiness::getCityByPid($request, $this, $parent_id);
//        // $childKV = CTAPIStaffExtendBusiness::getChildListKeyVal($request, $this, $parent_id, 1 + 0);
//
...
//        $resultDatas = CTAPIStaffExtendBusiness::importByFile($request, $this, $fileName);
//        return ajaxDataArr(1, $resultDatas, '');
//    }

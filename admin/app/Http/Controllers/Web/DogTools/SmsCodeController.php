...
use App\Business\Controller\API\DogTools\CTAPISmsCodeBusiness;
...
//        return view('web.DogTools.SmsCode.index', $reDataArr);
//    }
...
//        return view('web.DogTools.SmsCode.select', $reDataArr);
//    }
...
//        return view('web.DogTools.SmsCode.add', $reDataArr);
//    }

    /**
     * @ OA\Get(
     *     path="/api/web/dogtools/sms_code/ajax_info",
     *     tags={"前端-老师管理-验证码"},
     *     summary="验证码--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="webDogToolsSmsCodeAjax_info",
     *     deprecated=false,
     *     @ OA\Parameter(ref="#/components/parameters/Accept"),
     *     @ OA\Parameter(ref="#/components/parameters/Schema_DogTools_sms_code_id_required"),
     *     @ OA\Response(response=200,ref="#/components/responses/Response_DogTools_info_sms_code"),
     *     @ OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @ OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_DogTools_info_sms_code"}
     */
    /**
     * ajax获得详情数据
     *
...
//    }
    ...
    /**
     * @ OA\Post(
     *     path="/api/web/dogtools/sms_code/ajax_save",
     *     tags={"前端-老师管理-验证码"},
     *     summary="验证码--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="webDogToolsSmsCodeAjax_save",
     *     deprecated=false,
     *     @ OA\Parameter(ref="#/components/parameters/Accept"),
     *     @ OA\Parameter(ref="#/components/parameters/Schema_DogTools_sms_code_id_required"),
...
//    }
    ...
    /**
     * @ OA\Get(
     *     path="/api/web/dogtools/sms_code/ajax_alist",
     *     tags={"前端-老师管理-验证码"},
     *     summary="验证码--列表",
     *     description="验证码--列表......",
     *     operationId="webDogToolsSmsCodeAjax_alist",
     *     deprecated=false,
     *     @ OA\Parameter(ref="#/components/parameters/Accept"),
     *     @ OA\Parameter(ref="#/components/parameters/Schema_DogTools_sms_code_id_optional"),
     *     @ OA\Response(response=200,ref="#/components/responses/Response_DogTools_list_sms_code"),
     *     @ OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @ OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//        $this->InitParams($request);
//        return  CTAPISmsCodeBusiness::getList($request, $this, 2 + 4);
//    }
...
//    }
    ...
    /**
     * @ OA\Post(
     *     path="/api/web/dogtools/sms_code/ajax_del",
     *     tags={"前端-老师管理-验证码"},
     *     summary="验证码--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="webDogToolsSmsCodeAjax_del",
     *     deprecated=false,
     *     @ OA\Parameter(ref="#/components/parameters/Accept"),
     *     @ OA\Parameter(ref="#/components/parameters/Schema_DogTools_sms_code_id_required"),

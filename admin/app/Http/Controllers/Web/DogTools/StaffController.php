...
//        return view('web.DogTools.Staff.index', $reDataArr);
//    }
...
//        return view('web.DogTools.Staff.select', $reDataArr);
//    }
...
//        return view('web.DogTools.Staff.add', $reDataArr);
//    }

    /**
     * @ OA\Get(
     *     path="/api/web/dogtools/staff/ajax_info",
     *     tags={"前端-系统管理-帐号管理"},
     *     summary="帐号管理--详情",
     *     description="根据单个id,查询详情记录......",
     *     operationId="webDogToolsStaffAjax_info",
     *     deprecated=false,
     *     @ OA\Parameter(ref="#/components/parameters/Accept"),
     *     @ OA\Parameter(ref="#/components/parameters/Schema_DogTools_staff_id_required"),
     *     @ OA\Response(response=200,ref="#/components/responses/Response_DogTools_info_staff"),
     *     @ OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @ OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
     *     requestBody={"$ref": "#/components/requestBodies/RequestBody_DogTools_info_staff"}
     */
    /**
     * ajax获得详情数据
     *
...
//    }
    ...
    /**
     * @ OA\Post(
     *     path="/api/web/dogtools/staff/ajax_save",
     *     tags={"前端-系统管理-帐号管理"},
     *     summary="帐号管理--新加/修改",
     *     description="根据单个id,新加/修改记录(id>0:修改；id=0:新加)......",
     *     operationId="webDogToolsStaffAjax_save",
     *     deprecated=false,
     *     @ OA\Parameter(ref="#/components/parameters/Accept"),
     *     @ OA\Parameter(ref="#/components/parameters/Schema_DogTools_staff_id_required"),
...
//    }
    ...
    /**
     * @ OA\Get(
     *     path="/api/web/dogtools/staff/ajax_alist",
     *     tags={"前端-系统管理-帐号管理"},
     *     summary="帐号管理--列表",
     *     description="帐号管理--列表......",
     *     operationId="webDogToolsStaffAjax_alist",
     *     deprecated=false,
     *     @ OA\Parameter(ref="#/components/parameters/Accept"),
     *     @ OA\Parameter(ref="#/components/parameters/Schema_DogTools_staff_id_optional"),
     *     @ OA\Response(response=200,ref="#/components/responses/Response_DogTools_list_staff"),
     *     @ OA\Response(response=400,ref="#/components/responses/common_Response_err_400"),
     *     @ OA\Response(response=404,ref="#/components/responses/common_Response_err_404"),
     * )
     *     请求主体对象
...
//    }
    ...
    /**
     * @ OA\Post(
     *     path="/api/web/dogtools/staff/ajax_del",
     *     tags={"前端-系统管理-帐号管理"},
     *     summary="帐号管理--删除",
     *     description="根据单个id,删除记录......",
     *     operationId="webDogToolsStaffAjax_del",
     *     deprecated=false,
     *     @ OA\Parameter(ref="#/components/parameters/Accept"),
     *     @ OA\Parameter(ref="#/components/parameters/Schema_DogTools_staff_id_required"),

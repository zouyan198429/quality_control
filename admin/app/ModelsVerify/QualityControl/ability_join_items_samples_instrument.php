...
class ability_join_items_samples_instrument extends BaseDBVerify
{
    public static $model_name = 'QualityControl\AbilityJoinItemsSamplesInstrument';// 相对于Models的数据模型名称;在子类中定义，使用时用static::,不用self::
    public static $table_name = 'ability_join_items_samples_instrument';// 数据表名称
    // 需要从父的去掉的字段  -- 一维数组
     ...
     * 个人访问客户端属性-品牌名称
     * @ OA\Schema(
     *   schema="Schema_QualityControl_ability_join_items_samples_instrument_brand_name",
     *   type="string",
     ...
     * 上面字段对应的查询参数--可填
     * @ OA\Parameter(
     *      parameter="Schema_QualityControl_ability_join_items_samples_instrument_brand_name_optional",
     *      name="type_name",
     *      in="query",
     *      description="类型名称",
     *      required=false,
     *      deprecated=false,
     *      @ OA\Schema(ref="#/components/schemas/Schema_QualityControl_ability_join_items_samples_instrument_brand_name")
     * ),
     *
     *
     */
     ...
     * 上面字段对应的查询参数--必填
     * @ OA\Parameter(
     *      parameter="Schema_QualityControl_ability_join_items_samples_instrument_brand_name_required",
     *      name="type_name",
     *      in="query",
     *      description="类型名称",
     *      required=true,
     ...
     * 个人访问客户端属性-id
     * @OA\Schema(
     *   schema="Schema_QualityControl_ability_join_items_samples_instrument_id",
     *   type="integer",
     *   format="int32",
     *   title="个人访问客户端属性-id",
     ...
     * 上面字段对应的查询参数--可填
     * @OA\Parameter(
     *      parameter="Schema_QualityControl_ability_join_items_samples_instrument_id_optional",
     *      name="id",
     *      in="query",
     *      description="模板库分类-id",
     *      required=false,
     *      deprecated=false,
     *      @OA\Schema(ref="#/components/schemas/Schema_QualityControl_ability_join_items_samples_instrument_id")
     * ),
     *
     *
     */
     ...
     * 上面字段对应的查询参数--必填
     * @OA\Parameter(
     *      parameter="Schema_QualityControl_ability_join_items_samples_instrument_id_required",
     *      name="id",
     *      in="query",
     *      description="模板库分类-id",
     *      required=true,
     ...
     * 上面字段对应的查询参数--可填
     * @OA\Parameter(
     *      parameter="Schema_QualityControl_ability_join_items_samples_instrument_id_optional_quote",
     ...
     * 上面字段对应的查询参数--必填
     * @OA\Parameter(
     *      parameter="Schema_QualityControl_ability_join_items_samples_instrument_id_required_quote",
     *      name="template_type_id",
     *      in="query",
     *      description="模板库分类-id",
     *      required=true,
     ...
     * 模糊查询字段名--具体的表模型用
     * @OA\Parameter(
     *      parameter="Parameter_QualityControl_ability_join_items_samples_instrument_field",
     *      name="field",
     *      in="query",
     *      description="模糊查询字段名",
     *      required=false,
    ...
    /**
     * @OA\Schema(
     *     schema="Schema_QualityControl_ability_join_items_samples_instrument_obj",
     *     title="个人访问客户端",
     ...
     *
     * @OA\RequestBody(
     *     request="RequestBody_QualityControl_info_ability_join_items_samples_instrument",
     *     description="单个增加",
     *     required=true,
     *     @OA\JsonContent(ref="#/components/schemas/Schema_QualityControl_ability_join_items_samples_instrument_obj"),
     *     @OA\MediaType(
     *         mediaType="application/xml",
     *         @OA\Schema(
     *              @OA\Property(property="info", ref="#/components/schemas/Schema_QualityControl_ability_join_items_samples_instrument_obj"),
     *              @OA\Xml(
     *                  name="root",
     *                  wrapped=true
     *              ),
     ...
     *
     * @OA\RequestBody(
     *     request="RequestBody_QualityControl_multi_ability_join_items_samples_instrument",
     *     description="批量增加",
     *     required=true,
     *     @OA\JsonContent(
     *          type="object",
     ...
     *              property="data_list",
     *              type="array",
     *              @OA\Items(ref="#/components/schemas/Schema_QualityControl_ability_join_items_samples_instrument_obj"),
     *          ),
     *     ),
     *     @OA\MediaType(
     *         mediaType="application/xml",
     ...
     * 列表页
     *     @OA\Response(
     *         response="Response_QualityControl_list_ability_join_items_samples_instrument",
     *         description="操作成功返回",
     *         @OA\JsonContent(
     *              type="object",
     ...
     * }
     *     @OA\Response(
     *         response="Response_QualityControl_info_ability_join_items_samples_instrument",
     *         description="操作成功返回",
     *         @OA\JsonContent(
     *              type="object",
     *              @OA\Property(property="apistatus", ref="#/components/schemas/common_Schema_apistatus"),
     ...
     * }
     *     @OA\Response(
     *         response="Response_QualityControl_result_ability_join_items_samples_instrument",
     *         description="操作成功返回",
     *         @OA\JsonContent(
     *              type="object",
     *              @OA\Property(property="apistatus", ref="#/components/schemas/common_Schema_apistatus"),
     *              @OA\Property(property="result",ref="#/components/schemas/Schema_QualityControl_ability_join_items_samples_instrument_obj"),
     *              @OA\Property(property="errorMsg", ref="#/components/schemas/common_Schema_errorMsg"),
     *        ),
     *        @OA\XmlContent(
     *              type="object",

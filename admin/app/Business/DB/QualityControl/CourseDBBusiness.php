...
//                }
            ...
            // 如果是新加，则记录注册记录
            if($hasSourseContent) {
                $content_ids = CourseContentDBBusiness::updateByDataList(['course_id' => $id], ['course_id' => $id]
                    , ['course_content' => $SourseContent], $isModify, $operate_staff_id, $operate_staff_id_history

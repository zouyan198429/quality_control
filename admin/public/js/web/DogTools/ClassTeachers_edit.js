...
function ajax_form(){
    ...
    // 老师角色
    var teacher_role_id = $('select[name=teacher_role_id]').val();
    // var judge_seled = judge_validate(1,'是否开启',teacher_role_id,true,'custom',/^[012]$/,"");
    var judge_seled = judge_validate(1,'角色',teacher_role_id,true,'digit','',"");
    if(judge_seled != ''){
    ...
    var judge_seled = judge_validate(1,'审核状态',open_status,true,'digit','',"");
    if(judge_seled != ''){
